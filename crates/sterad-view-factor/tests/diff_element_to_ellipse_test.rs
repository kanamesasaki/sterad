...
///
fn diff_element_to_ellipse_numerical(
    a: f64,
    b: f64,
    theta: f64,
    phi: f64,
...
#[cfg(test)]
mod tests {
    use super::diff_element_to_ellipse_numerical;
    use std::f64::consts::PI;
    ...
    fn test_diff_element_to_ellipse() {
        ...
        println!("vf_ana: {}", vf_ana);
        println!("vf_num: {}", vf_num);
        assert!((vf_ana - vf_num).abs() < 1e-6);
    }
}
